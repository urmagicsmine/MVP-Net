...
if [ "$1" == "train" ]
then
	CUDA_VISIBLE_DEVICES=4,5,6,7 python tools/train_net_step.py --dataset lesion_train --cfg configs/lesion_baselines/multi_windows_3_slices.yaml --bs 4 --nw 4 --use_tfboard
elif [ "$1" == "test" ]
then
