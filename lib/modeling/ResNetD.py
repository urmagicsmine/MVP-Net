...
# ---------------------------------------------------------------------------- #
# Bits for specific architectures (ResNetD50, ResNetD101, ...)
# ---------------------------------------------------------------------------- #

def ResNetD50_conv4_body():
    return ResNetD_convX_body((3, 4, 6))


def ResNetD50_conv5_body():
    return ResNetD_convX_body((3, 4, 6, 3))


def ResNetD101_conv4_body():
    return ResNetD_convX_body((3, 4, 23))


def ResNetD101_conv5_body():
    return ResNetD_convX_body((3, 4, 23, 3))


def ResNetD152_conv5_body():
    return ResNetD_convX_body((3, 8, 36, 3))


# ---------------------------------------------------------------------------- #
# Generic ResNetD components
# ---------------------------------------------------------------------------- #


class ResNetD_convX_body(nn.Module):
...
class ResNetD_roi_conv5_head(nn.Module):
