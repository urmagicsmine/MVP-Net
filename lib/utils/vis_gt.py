...
def vis_bbox_opencv(img, bbox, thick=1, color=(0,255,0)):
...
def get_class_string(class_index, score, dataset):
    ...
    return str(class_text + ' {:0.2f}'.format(score).lstrip('0'))


def get_gt_class_string(class_index, dataset):
    class_text = dataset.classes[class_index] if dataset is not None else \
        'id{:d}'.format(class_index)
    return str(class_text)
