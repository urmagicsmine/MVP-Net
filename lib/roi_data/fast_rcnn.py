...
# To set proposals as neither fg nor bg, we need to set max_overlaps to numbers 
# lower than cfg.TRAIN.BG_THRESH_LO, i.e. -1 as they did in _filter_crowd_proposals 
def _sample_rois(roidb, im_scale, batch_idx):
    ...
    #print(fg_inds, max_overlaps.shape, roidb['box_to_gt_ind_map'].shape)
    ...
    #print("RCNN training bg/fg: %d/%d"%(len(fg_inds), len(bg_inds)))
    #print(bg_inds)
